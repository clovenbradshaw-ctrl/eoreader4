...
test('scrubGraphLines strips a composite id prefix to the human label', () => {
  const out = scrubGraphLines(['Ryan Coogler --leads--> web-30cb0466e65f1f7d␟room']);
  assert.deepEqual(out, ['Ryan Coogler --leads--> room']);
});
